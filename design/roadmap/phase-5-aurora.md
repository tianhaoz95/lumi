...
- [x] **1.3.1** Implement the grain texture as an SVG-based background at 2–3% opacity, fixed in position.  <!-- Implemented: simplified SVG to avoid unsupported filters in flutter_svg -->
