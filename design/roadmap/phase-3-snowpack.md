...
- [x] **1.2.3** Embed the new transaction into LanceDB (`embed_transaction` helper, see §3).
...
- [x] **4.3.2** When the agent calls a tool and returns data, render the result as an **InsightCard** in the chat:
